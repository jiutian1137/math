...
/// Functions of Number
/// 
///@license Please identify the articles of specified function or class, 2020-2022
...
#ifndef __math_lerp__
#define __math_lerp__
/// linear interpolation from 'start' to 'end' with 't'.
template<typename Ty1, typename Ty2> inline
...
*/
template<typename Number>
	requires std::is_scalar_v<Number>
...
*/
template<typename Number>
	requires std::floating_point<Number> inline
